...
// SOCKETS
exports.connectSocket = async (dartObservatoryURL) => {
    let retryCount = 0;
    ...
    while (retryCount < MAX_RETRY_COUNT && !connectedSocket) {
        ...
        const connectedPromise = new Promise((resolve) => {
            ...
            const socket = new rpc_websockets_1.Client(dartObservatoryURL);
...
exports.executeElementCommand = async function (command, elementBase64, extraArgs = {}) {
    ...
    const data = await exports.executeSocketCommand(this.socket, serializedCommand);
...
exports.executeSocketCommand = async (socket, cmd) => 
